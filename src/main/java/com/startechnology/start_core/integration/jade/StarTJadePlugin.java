...
public class StarTJadePlugin implements IWailaPlugin {
    ...
    public void register(IWailaCommonRegistration registration) {
        ...
        registration.registerBlockDataProvider(new StarTMEWirelessProvider(), BlockEntity.class);
    }
    ...
    public void registerClient(IWailaClientRegistration registration) {
        ...
        registration.registerBlockComponent(new StarTMEWirelessProvider(), Block.class);
    }
}
